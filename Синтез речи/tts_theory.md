...
# Vocoder
## Wave Net
Самый первый генератор

## GAN
- есть 2 модели Генератор и Дискриминатор
- Дискриминатор учится классифицировать настоящий пример и сгенерированный пример
- Генератор учится делать примеры, которые дискриминатор будет считать за настоящие
![](img/GAN.png)

## Wave_GAN
- Обучается в 2 этапа:
    - Сначала на STFT Loss: получаем модель которая правильно произносит слова. Но голос металический
    - Тут в дело входит состязательный лосс от Дискриминатора. В итоге голос становится более естественным
![](img/Parallel_WaveGAN.png)
